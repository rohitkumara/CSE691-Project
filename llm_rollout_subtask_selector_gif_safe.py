...
"""
        ...
        score = execute_plan_with_gif(env_copy, plan, path, gif_name=f"rollout_{sanitize_filename(subtask)}.gif")
        if score == float('inf'):
...
def fortified_rollout_planner():
    ...
    final_steps = execute_plan_with_gif(final_env, overall_best_plan, final_path, gif_name="final_best_plan.gif")
