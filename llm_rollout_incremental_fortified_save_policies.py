...
def fortified_incremental_rollout_planner():
    ...
    while True:
        ...
        for subtask in subtasks:
            ...
            save_path = f"plans_iteration_{iteration}/plan_{sanitize_filename('_'.join(candidate_chain))}.txt"
        ...
        if best_local_plan and best_local_score < best_cost:
            ...
            save_best_path = f"plans_iteration_{iteration}/best_plan_iteration_{iteration}.txt"
            save_plan_text(best_plan, save_best_path)
