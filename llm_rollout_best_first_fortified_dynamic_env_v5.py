...
def best_first_fortified_rollout_planner():
    ...
    while not done and iteration < MAX_DEPTH:
        num_subtasks = 8 if iteration <= 1 else (6 if iteration == 2 else 3)
        ...
        _ = execute_plan_with_gif(current_env, plan, path, gif_name=f"rollouts/rollout_depth{iteration}_best.gif")
